...
namespace Chummer.Android.Native
{
    ...
    public sealed class RunnerSessionCoordinator
    {
        ...
        public Task<Chummer.Presentation.Overview.CareerKnowledgeSkillAdvanceEditorState?>
            PrepareCareerKnowledgeSkillAdvanceAsync(CancellationToken cancellationToken)
            => Task.FromResult<Chummer.Presentation.Overview.CareerKnowledgeSkillAdvanceEditorState?>(null);

        public Task<bool> ApplyCareerKnowledgeSkillAdvanceAsync(
            Chummer.Presentation.Overview.CareerKnowledgeSkillAdvanceRequest request,
