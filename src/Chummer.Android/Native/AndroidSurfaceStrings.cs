...
public static class AndroidSurfaceStrings
{
    private static readonly IReadOnlyDictionary<string, string> English = Catalog(
        ...
        ("Origin.SceneExplanation", "Add a downloaded scene, for example from Phygital+ or OneMinAI. Describe it, choose a PNG/JPEG and review the preview before saving. The image stays private and is included offline in EPUB/HTML. No generation or upload is started. One scene per chapter, up to 8 per book; 4 MB and 4096 pixels per image, 16 MB in total."),
    ...
    private static readonly IReadOnlyDictionary<string, string> German = Translate(English,
        ...
        ("Origin.SceneExplanation", "Füge eine heruntergeladene Szene hinzu, etwa aus Phygital+ oder OneMinAI. Beschreibe sie, wähle eine PNG/JPEG-Datei und prüfe die Vorschau vor dem Speichern. Das Bild bleibt privat und wird offline in EPUB/HTML eingebettet. Es startet keine Generierung und kein Upload. Ein Bild pro Kapitel, bis zu 8 pro Buch; je 4 MB und 4096 Pixel, insgesamt 16 MB."),
    ...
    private static readonly IReadOnlyDictionary<string, string> Spanish = Translate(English,
        ...
        ("Origin.SceneExplanation", "Añade una escena descargada, por ejemplo de Phygital+ o OneMinAI. Descríbela, elige un PNG/JPEG y revisa la vista previa antes de guardar. La imagen queda privada y se incluye sin conexión en EPUB/HTML. No inicia ninguna generación ni subida. Una escena por capítulo, hasta 8 por libro; 4 MB y 4096 píxeles por imagen, 16 MB en total."),
