...
public static class AndroidSurfaceStrings
{
    private static readonly IReadOnlyDictionary<string, string> English = Catalog(
        ...
        ("Origin.ProseAcknowledgement", "I have reviewed this exact text and want to use it in my private book."),
    ...
    private static readonly IReadOnlyDictionary<string, string> German = Translate(English,
        ...
        ("Origin.ProseAcknowledgement", "Ich habe genau diesen Text geprüft und möchte ihn in meinem privaten Buch verwenden."),
    ...
    private static readonly IReadOnlyDictionary<string, string> Spanish = Translate(English,
        ...
        ("Origin.ProseAcknowledgement", "He revisado este texto exacto y quiero usarlo en mi libro privado."),
