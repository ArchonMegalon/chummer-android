...
def main() -> int:
    ...
    source_paths = {
        ...
        "linkedIntentJournalSha256": android_root / "src" / "Chummer.Android" / "Native" / "AndroidLinkedCharacterIntentJournal.cs",
        "linkedWorkspaceReaderSha256": android_root / "src" / "Chummer.Android" / "Native" / "AndroidLinkedWorkspaceReader.cs",
        "linkedRecoveryPageSha256": android_root / "src" / "Chummer.Android" / "Native" / "LinkedCharacterRecoveryPage.cs",
        ...
        "workspaceLinkedCharacterMutationPreviewSha256": presentation_root / "WorkspaceLinkedCharacterMutationPreview.cs",
