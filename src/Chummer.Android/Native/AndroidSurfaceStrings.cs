...
public static class AndroidSurfaceStrings
{
    private static readonly IReadOnlyDictionary<string, string> English = Catalog(
        ...
        ("Resources.Intro", "Choose how much creation Karma to convert into nuyen."),
        ("Resources.ShowDetails", "Show technical details"),
        ("Resources.HideDetails", "Hide technical details"),
        ("Resources.SavedRevision", "Saved revision"),
        ("Resources.SnapshotDigest", "Snapshot digest"),
        ("Resources.CharacterDigest", "Character XML digest"),
        ("Resources.AuxiliaryDigest", "Auxiliary state digest"),
        ("Resources.PrerequisiteDigest", "Prerequisite draft digest"),
        ("Resources.DraftDigest", "Resources draft digest"),
        ("Resources.SourceDigest", "Source digest"),
        ...
        ("Origin.ReadBook", "Read your story"),
        ("Origin.ChooseMetatype", "Choose metatype"),
        ("Origin.ChooseNationality", "Choose nationality"),
        ("Origin.MetatypeReviewDetail", "Choose explicitly. Metatype and nationality costs are reviewed together before anything is saved."),
        ("Origin.BookDraft", "Origin Dossier · draft"),
        ("Origin.BookLanguage", "Story language: {0}"),
        ("Origin.BookSavedChapters", "These chapters follow your saved decisions. Further Life Modules and book generation are not yet complete."),
        ("Origin.BookMetadata", "Technical author: {0} · private story, not published"),
    ...
    private static readonly IReadOnlyDictionary<string, string> German = Translate(English,
        ...
        ("Resources.Title", "Ressourcen"), ("Resources.Intro", "Wähle, wie viel Erschaffungskarma in Nuyen umgewandelt wird."),
        ("Resources.ShowDetails", "Technische Details anzeigen"),
        ("Resources.HideDetails", "Technische Details ausblenden"),
        ("Resources.SavedRevision", "Gespeicherte Revision"),
        ("Resources.SnapshotDigest", "Prüfsumme des Snapshots"),
        ("Resources.CharacterDigest", "Prüfsumme des Charakter-XML"),
        ("Resources.AuxiliaryDigest", "Prüfsumme des Zusatzstatus"),
        ("Resources.PrerequisiteDigest", "Prüfsumme des Voraussetzungentwurfs"),
        ("Resources.DraftDigest", "Prüfsumme des Ressourcenentwurfs"),
        ("Resources.SourceDigest", "Prüfsumme der Quellen"),
        ...
        ("Origin.ReadBook", "Deine Geschichte lesen"),
        ("Origin.ChooseMetatype", "Metatyp auswählen"),
        ("Origin.ChooseNationality", "Nationalität auswählen"),
        ("Origin.MetatypeReviewDetail", "Triff deine Wahl. Die Kosten für Metatyp und Nationalität werden gemeinsam geprüft, bevor etwas gespeichert wird."),
        ("Origin.BookDraft", "Origin Dossier · Entwurf"),
        ("Origin.BookLanguage", "Sprache der Geschichte: {0}"),
        ("Origin.BookSavedChapters", "Diese Kapitel folgen deinen gespeicherten Entscheidungen. Weitere Lebensmodule und die Bucherstellung sind noch nicht vollständig verfügbar."),
        ("Origin.BookMetadata", "Technischer Autor: {0} · private Geschichte, nicht veröffentlicht"),
    ...
    private static readonly IReadOnlyDictionary<string, string> Spanish = Translate(English,
        ...
        ("Resources.Title", "Recursos"), ("Resources.Intro", "Elige cuánto Karma de creación convertir en nuyen."),
        ("Resources.ShowDetails", "Mostrar detalles técnicos"),
        ("Resources.HideDetails", "Ocultar detalles técnicos"),
        ("Resources.SavedRevision", "Revisión guardada"),
        ("Resources.SnapshotDigest", "Resumen de la instantánea"),
        ("Resources.CharacterDigest", "Resumen del XML del personaje"),
        ("Resources.AuxiliaryDigest", "Resumen del estado auxiliar"),
        ("Resources.PrerequisiteDigest", "Resumen del borrador de requisitos"),
        ("Resources.DraftDigest", "Resumen del borrador de recursos"),
        ("Resources.SourceDigest", "Resumen de las fuentes"),
        ...
        ("Origin.ReadBook", "Leer tu historia"),
        ("Origin.ChooseMetatype", "Elegir metatipo"),
        ("Origin.ChooseNationality", "Elegir nacionalidad"),
        ("Origin.MetatypeReviewDetail", "Elige explícitamente. Los costes de metatipo y nacionalidad se revisan juntos antes de guardar."),
        ("Origin.BookDraft", "Origin Dossier · borrador"),
        ("Origin.BookLanguage", "Idioma de la historia: {0}"),
        ("Origin.BookSavedChapters", "Estos capítulos siguen tus decisiones guardadas. Los demás módulos de vida y la creación del libro aún no están completos."),
        ("Origin.BookMetadata", "Autor técnico: {0} · historia privada, no publicada"),
