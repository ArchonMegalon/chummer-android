...
public static class AndroidSurfaceStrings
{
    private static readonly IReadOnlyDictionary<string, string> English = Catalog(
        ...
        ("Origin.AffordableChoicesOnly", "Showing only choices within your remaining Karma budget."),
        ("Origin.NoAffordableChoices", "No choice fits the remaining Karma budget. Go back to review your saved creation choices; no new module has been selected."),
        ("Origin.BookLoading", "Loading your saved story…"),
        ("Origin.ExportBook", "Save book as HTML"),
        ("Origin.ExportEpub", "Save book as EPUB"),
        ("Origin.SceneTitle", "Chapter illustration"),
        ("Origin.SceneRemoteExplanation", "For a linked, reader-accepted chapter, you can also request a private illustration. Review or shorten the suggested excerpt below, or replace it with another exact excerpt from this chapter. The server chooses an approved provider; no image is added until you review it."),
        ("Origin.SceneExcerpt", "Exact scene excerpt from this chapter (up to 3 KB)"),
        ("Origin.SceneConsent", "I allow Chummer to send this excerpt to OneMinAI or Phygital+ for one private illustration, using existing credits. No purchase or public publication."),
        ("Origin.SceneRequest", "Request this illustration"),
        ("Origin.SceneRead", "Check existing illustration (no generation)"),
        ("Origin.SceneWaiting", "Contacting the private illustration service… There is no reliable completion estimate yet. Your saved book remains readable."),
        ("Origin.SceneReview", "Review the image, then choose “Use this scene” to retain it offline and include it in EPUB/HTML. This does not publish it."),
        ("Origin.SceneAbsent", "No illustration exists for this exact chapter text. Creating one requires the excerpt consent above."),
        ("Origin.SceneUnknown", "The illustration may still be processing, or its acknowledgement was lost. Use “Check existing illustration” later; do not create another request. No reliable ETA is available."),
        ("Origin.SceneConflict", "Reopen the chapter and check that its selected reading edition has been acknowledged by the server. No replacement image was requested."),
        ("Origin.SceneUnavailable", "The private illustration service is unavailable, or the account/book changed. Your saved book is unchanged. You can still choose a local image."),
        ("Origin.SceneReject", "Reject this generated image (no regeneration)"),
        ("Origin.SceneClosed", "This image was rejected or expired. It will not be regenerated automatically; local images remain available."),
        ("Origin.SceneExplanation", "Local file: describe a downloaded scene, choose a PNG/JPEG and review it before saving. Local selection starts no generation or upload. The image stays private and is included offline in EPUB/HTML. One scene per chapter, up to 8 per book; 4 MB and 4096 pixels per image, 16 MB in total."),
        ("Origin.SceneDescription", "Describe the scene for readers who cannot see the image"),
        ("Origin.SceneChoose", "Choose a rendered scene"),
        ("Origin.SceneSave", "Use this scene in my book"),
        ("Origin.SceneRemove", "Remove the book’s copy of this scene"),
        ("Origin.SceneInvalid", "This scene could not be saved. Use a valid PNG/JPEG within the image and book limits. Your saved book is unchanged."),
        ("Origin.ScenesUnavailable", "Saved illustrations could not be read. Your story is still available; this export contains text only. The stored images have not been overwritten."),
        ("Origin.ReviewProse", "Review chapter draft"),
        ("Origin.AuthorChapter", "Write chapter with First Book AI"),
        ("Origin.AuthoringBusy", "Checking your private chapter request… You can leave this page; your saved book stays available."),
        ("Origin.AuthoringExplanation", "Only the following confirmed facts, runner name and story language are sent. No character file or rulebook text. The generated text remains a draft for your review."),
        ("Origin.AuthoringConsent", "I agree to send these facts to First Book AI for this chapter. This does not share or publish my story."),
        ("Origin.AuthoringRequest", "Request or resume chapter"),
        ("Origin.AuthoringRefresh", "Check existing chapter request"),
        ("Origin.AuthoringNotFound", "No request exists yet. Review the facts and consent before requesting a chapter."),
        ("Origin.AuthoringQueued", "Request saved. Waiting for authoring; you can leave this page and check back later."),
        ("Origin.AuthoringReconciling", "Authoring has been dispatched. Its result is being reconciled; no new generation will be submitted."),
        ("Origin.AuthoringReady", "The chapter draft is ready to review. Your reading edition has not changed."),
        ("Origin.AuthoringUnknown", "The response was lost. Check this same request later; do not start another generation."),
        ("Origin.AuthoringUnavailable", "Chapter authoring is unavailable or the account changed. Your saved book is unchanged."),
        ("Origin.AuthoringStatusRetrying", "Status check interrupted. Showing the last confirmed stage; checking the same request again shortly. No new generation is started."),
        ("Origin.AuthoringStatusInterrupted", "The connection was interrupted while checking the chapter. Use ‘Check existing chapter request’ to try again. Your saved book and last confirmed stage are unchanged; no new generation is started."),
        ("Origin.AuthoringStatusPaused", "Automatic status checks reached their limit and are paused. Use ‘Check existing chapter request’ to resume. Your saved book is unchanged."),
        ("Origin.ProseStale", "This draft belongs to an older chapter or language. You may discard it, but cannot use it in this version."),
        ("Origin.ProseReviewNotice", "This is a proposed reading version, not verified character history. Check names, biography and the decision boundary. It cannot change rules or saved choices."),
        ("Origin.ProseCurrent", "Current reading version"), ("Origin.ProseProposed", "Proposed text"),
        ("Origin.ProseAcknowledgement", "I have reviewed this exact text. Use it in my private book and confirm this chapter to the writing service so the next chapter can follow."),
        ("Origin.ProseUse", "Use in my book"), ("Origin.ProseDiscard", "Discard this draft"),
        ("Origin.ProseReviewSaved", "Review saved. Return to the book to read or export it. Nothing was published."),
        ("Origin.BookUnavailable", "No saved book is available in this runner context. Reopen the dossier if the runner or account changed."),
        ("Origin.BookAccount", "Account & privacy"),
        ("Origin.BookAccountExplanation", "First Book AI narration requires a linked account. You can read and export this saved book without linking. Opening account settings does not upload this runner or start chapter generation."),
        ("Origin.BookExported", "Book saved. It has not been published."),
        ("Origin.BookExportCancelled", "Book export cancelled."),
        ...
        ("Origin.BookSavedChapters", "These draft chapters follow your saved decisions. Narrative enrichment is not yet complete."),
        ("Origin.OpeningSetupTitle", "Starting situation"),
        ("Origin.StoryReadChecking", "Checking the reading version of your saved story…"),
        ("Origin.StoryReadRequired", "Before choosing the next module, open your story, request the current chapter if needed, and read and accept the finished text. Your initial choices are saved. No new chapter is requested automatically."),
        ("Origin.StoryReadRefresh", "Check reading status"),
        ("Origin.AuthoringStage", "Writing stage {0} of 3: requested → dispatched → draft ready. This bar shows confirmed stages, not elapsed time. Read and accept the draft to continue."),
        ("Origin.AuthoringEtaUnknown", "ETA: not available — the writing service has not supplied a reliable estimate. Check this same request again; you can leave safely."),
        ("Origin.OpeningSetupRequired", "First confirm your metatype, birth background and childhood. These choices establish the starting situation before the first story chapter is generated."),
        ("Origin.OpeningSetupReady", "Metatype, birth background and childhood form the first chapter together. Later chapters follow your next confirmed decisions."),
        ("Origin.ModuleSelectionSaved", "Module selection saved. Rule effects and the transition to Career still need review and explicit confirmation."),
        ...
        ("Origin.ContributionScope", "Module contributions, not final character ratings. Cumulative effects are checked before entering Career."),
        ("Origin.EffectReviewRequired", "This saved preview predates the compiler review. Select the module again and review before confirming."),
        ("Origin.AttributeContribution", "Attribute · {0}: {1}"),
        ("Origin.SkillContribution", "Active skill · {0}: {1}"),
        ("Origin.GroupContribution", "Skill group · {0}: {1}"),
        ("Origin.KnowledgePoolContribution", "Knowledge skill pool: {0}; no automatic skill or native-language grant"),
        ("Origin.PositivePoolContribution", "Positive-quality Karma allowance: {0}"),
        ("Origin.NegativePoolContribution", "Negative-quality Karma allowance: {0}"),
        ("Origin.QualityLevelContribution", "{0} · tier {1} (highest module tier applies)"),
        ("Origin.QualityContribution", "Quality · {0} {1}"),
        ("Origin.SelectionContribution", "Selection text (no separate rules bonus): {0}"),
        ("Origin.EffectPending", "{0}: still requires cumulative rules evaluation"),
        ("Origin.EffectSourceContext", "Descriptive source context, not an extra grant: {0}"),
        ...
        ("Origin.SavingDecision", "Saving decision…"),
        ("Origin.ReviewAnswers", "Review these answers"),
        ("Origin.AnswersDetail", "Answer the module's questions. Required answers are marked *. Nothing is applied until you review and confirm."),
        ("Origin.ChooseAnswer", "Choose an answer"),
        ("Origin.EnterAnswer", "Your answer"),
    ...
    private static readonly IReadOnlyDictionary<string, string> German = Translate(English,
        ...
        ("Origin.ContributionScope", "Modulbeiträge, keine endgültigen Charakterwerte. Kumulative Effekte werden vor dem Karrierebeginn geprüft."),
        ("Origin.EffectReviewRequired", "Diese gespeicherte Vorschau enthält noch keine Regelauswertung. Wähle das Modul erneut und prüfe es vor der Bestätigung."),
        ("Origin.AttributeContribution", "Attribut · {0}: {1}"),
        ("Origin.SkillContribution", "Aktionsfertigkeit · {0}: {1}"),
        ("Origin.GroupContribution", "Fertigkeitsgruppe · {0}: {1}"),
        ("Origin.KnowledgePoolContribution", "Wissensfertigkeiten-Pool: {0}; keine automatische Fertigkeit oder Muttersprache"),
        ("Origin.PositivePoolContribution", "Karmafreibetrag für Vorteile: {0}"),
        ("Origin.NegativePoolContribution", "Karmafreibetrag für Nachteile: {0}"),
        ("Origin.QualityLevelContribution", "{0} · Stufe {1} (höchste Modulstufe gilt)"),
        ("Origin.QualityContribution", "Vor-/Nachteil · {0} {1}"),
        ("Origin.SelectionContribution", "Auswahltext (kein eigener Regelbonus): {0}"),
        ("Origin.EffectPending", "{0}: kumulative Regelauswertung noch erforderlich"),
        ("Origin.EffectSourceContext", "Beschreibender Quellenkontext, kein zusätzlicher Bonus: {0}"),
        ...
        ("Origin.SavingDecision", "Entscheidung wird gespeichert…"),
        ("Origin.ReviewAnswers", "Antworten prüfen"),
        ("Origin.AnswersDetail", "Beantworte die Fragen des Moduls. Pflichtangaben sind mit * markiert. Erst nach Prüfung und Bestätigung wird etwas übernommen."),
        ("Origin.ChooseAnswer", "Antwort auswählen"), ("Origin.EnterAnswer", "Deine Antwort"),
        ("Origin.ReadBook", "Deine Geschichte lesen"),
        ("Origin.AffordableChoicesOnly", "Es werden nur Optionen angezeigt, die du mit deinem verbleibenden Karma bezahlen kannst."),
        ("Origin.NoAffordableChoices", "Keine Option passt zum verbleibenden Karma. Gehe zurück und prüfe deine gespeicherten Erschaffungsentscheidungen; es wurde kein neues Modul gewählt."),
        ("Origin.BookLoading", "Deine gespeicherte Geschichte wird geladen…"),
        ("Origin.ExportBook", "Buch als HTML speichern"),
        ("Origin.ExportEpub", "Buch als EPUB speichern"),
        ("Origin.SceneTitle", "Kapitelillustration"),
        ("Origin.SceneRemoteExplanation", "Für ein verknüpftes, zum Lesen übernommenes Kapitel kannst du auch eine private Illustration anfordern. Prüfe oder kürze den vorgeschlagenen Ausschnitt, oder ersetze ihn durch einen anderen Originalausschnitt dieses Kapitels. Der Server wählt einen freigegebenen Anbieter; ins Buch kommt das Bild erst nach deiner Prüfung."),
        ("Origin.SceneExcerpt", "Unveränderter Szenenausschnitt aus diesem Kapitel (bis 3 KB)"),
        ("Origin.SceneConsent", "Ich erlaube Chummer, diesen Ausschnitt für eine private Illustration an OneMinAI oder Phygital+ zu senden und vorhandene Credits zu nutzen. Kein Kauf und keine öffentliche Veröffentlichung."),
        ("Origin.SceneRequest", "Diese Illustration anfordern"),
        ("Origin.SceneRead", "Vorhandenes Bild abrufen (keine Generierung)"),
        ("Origin.SceneWaiting", "Der private Bilderdienst wird kontaktiert … Eine verlässliche Restzeit liegt noch nicht vor. Dein gespeichertes Buch bleibt lesbar."),
        ("Origin.SceneReview", "Prüfe das Bild. Mit „Diese Szene verwenden“ speicherst du es offline und bettest es in EPUB/HTML ein. Es wird nicht veröffentlicht."),
        ("Origin.SceneAbsent", "Für diesen genauen Kapiteltext gibt es noch kein Bild. Zum Erstellen ist die Ausschnitt-Freigabe oben erforderlich."),
        ("Origin.SceneUnknown", "Das Bild wird möglicherweise noch verarbeitet oder die Bestätigung ging verloren. Rufe später das vorhandene Bild ab; erstelle keinen weiteren Auftrag. Eine verlässliche Restzeit liegt nicht vor."),
        ("Origin.SceneConflict", "Öffne das Kapitel erneut und prüfe, ob der Server die gewählte Lesefassung bestätigt hat. Es wurde kein Ersatzbild angefordert."),
        ("Origin.SceneUnavailable", "Der private Bilderdienst ist nicht verfügbar oder Konto/Buch haben sich geändert. Dein gespeichertes Buch bleibt unverändert. Du kannst weiterhin ein lokales Bild wählen."),
        ("Origin.SceneReject", "Generiertes Bild ablehnen (keine Neugenerierung)"),
        ("Origin.SceneClosed", "Dieses Bild wurde abgelehnt oder ist abgelaufen. Es wird nicht automatisch neu erzeugt; lokale Bilder bleiben möglich."),
        ("Origin.SceneExplanation", "Lokale Datei: Beschreibe eine heruntergeladene Szene, wähle eine PNG/JPEG-Datei und prüfe die Vorschau. Diese Dateiauswahl startet keine Generierung und keinen Upload. Das Bild bleibt privat und wird offline in EPUB/HTML eingebettet. Ein Bild pro Kapitel, bis zu 8 pro Buch; je 4 MB und 4096 Pixel, insgesamt 16 MB."),
        ("Origin.SceneDescription", "Beschreibe die Szene für Leser, die das Bild nicht sehen können"),
        ("Origin.SceneChoose", "Gerenderte Szene auswählen"),
        ("Origin.SceneSave", "Diese Szene in meinem Buch verwenden"),
        ("Origin.SceneRemove", "Bildkopie aus dem Buch entfernen"),
        ("Origin.SceneInvalid", "Die Szene konnte nicht gespeichert werden. Verwende eine gültige PNG/JPEG-Datei innerhalb der Bild- und Buchgrenzen. Dein gespeichertes Buch bleibt unverändert."),
        ("Origin.ScenesUnavailable", "Gespeicherte Bilder konnten nicht gelesen werden. Deine Geschichte bleibt verfügbar; dieser Export enthält nur Text. Die gespeicherten Bilder wurden nicht überschrieben."),
        ("Origin.ReviewProse", "Kapitelentwurf prüfen"),
        ("Origin.AuthorChapter", "Kapitel mit First Book AI schreiben"),
        ("Origin.AuthoringBusy", "Deine private Kapitelanfrage wird geprüft… Du kannst die Seite verlassen; dein gespeichertes Buch bleibt verfügbar."),
        ("Origin.AuthoringExplanation", "Gesendet werden nur die folgenden bestätigten Fakten, der Runnername und die Erzählsprache. Keine Charakterdatei und kein Regelbuchtext. Der erzeugte Text bleibt ein Entwurf zur Prüfung."),
        ("Origin.AuthoringConsent", "Ich stimme zu, diese Fakten für dieses Kapitel an First Book AI zu senden. Meine Geschichte wird dadurch nicht geteilt oder veröffentlicht."),
        ("Origin.AuthoringRequest", "Kapitel anfordern oder fortsetzen"),
        ("Origin.AuthoringRefresh", "Bestehende Kapitelanfrage prüfen"),
        ("Origin.AuthoringNotFound", "Es gibt noch keine Anfrage. Prüfe die Fakten und stimme vor dem Anfordern zu."),
        ("Origin.AuthoringQueued", "Anfrage gespeichert. Die Ausarbeitung steht aus; du kannst die Seite verlassen und später nachsehen."),
        ("Origin.AuthoringReconciling", "Die Ausarbeitung wurde angestoßen. Das Ergebnis wird abgeglichen; es wird keine neue Generierung gestartet."),
        ("Origin.AuthoringReady", "Der Kapitelentwurf ist zur Prüfung bereit. Deine Leseausgabe ist unverändert."),
        ("Origin.AuthoringUnknown", "Die Antwort ging verloren. Prüfe später dieselbe Anfrage; starte keine weitere Generierung."),
        ("Origin.AuthoringUnavailable", "Die Kapitelerstellung ist nicht verfügbar oder das Konto hat gewechselt. Dein gespeichertes Buch bleibt unverändert."),
        ("Origin.AuthoringStatusRetrying", "Statusabruf unterbrochen. Der zuletzt bestätigte Stand bleibt sichtbar; dieselbe Anfrage wird gleich erneut geprüft. Es wird keine neue Generierung gestartet."),
        ("Origin.AuthoringStatusInterrupted", "Die Verbindung wurde beim Prüfen des Kapitels unterbrochen. Prüfe die bestehende Kapitelanfrage erneut. Dein gespeichertes Buch und der zuletzt bestätigte Stand bleiben unverändert; es wird keine neue Generierung gestartet."),
        ("Origin.AuthoringStatusPaused", "Die automatische Statusprüfung hat ihr Limit erreicht und pausiert. Prüfe die bestehende Kapitelanfrage erneut, um fortzufahren. Dein gespeichertes Buch bleibt unverändert."),
        ("Origin.ProseStale", "Dieser Entwurf gehört zu einem älteren Kapitel oder einer anderen Sprache. Du kannst ihn verwerfen, aber nicht in dieser Fassung verwenden."),
        ("Origin.ProseReviewNotice", "Dies ist eine vorgeschlagene Lesefassung, keine geprüfte Charakterhistorie. Prüfe Namen, Biografie und den Entscheidungspunkt. Regeln und gespeicherte Entscheidungen bleiben unverändert."),
        ("Origin.ProseCurrent", "Aktuelle Lesefassung"), ("Origin.ProseProposed", "Textvorschlag"),
        ("Origin.ProseAcknowledgement", "Ich habe genau diesen Text geprüft. In meinem privaten Buch verwenden und dieses Kapitel beim Schreibdienst bestätigen, damit das nächste folgen kann."),
        ("Origin.ProseUse", "Im Buch verwenden"), ("Origin.ProseDiscard", "Diesen Entwurf verwerfen"),
        ("Origin.ProseReviewSaved", "Prüfung gespeichert. Kehre zum Buch zurück, um es zu lesen oder zu exportieren. Nichts wurde veröffentlicht."),
        ("Origin.BookUnavailable", "Für diesen Runner-Kontext ist kein gespeichertes Buch verfügbar. Öffne das Dossier erneut, wenn Runner oder Konto gewechselt wurden."),
        ("Origin.BookAccount", "Konto & Datenschutz"),
        ("Origin.BookAccountExplanation", "Die Ausarbeitung mit First Book AI erfordert ein verknüpftes Konto. Du kannst dieses gespeicherte Buch auch ohne Verknüpfung lesen und exportieren. Das Öffnen der Kontoeinstellungen lädt den Runner nicht hoch und startet keine Kapitelerstellung."),
        ("Origin.BookExported", "Buch gespeichert. Es wurde nicht veröffentlicht."),
        ("Origin.BookExportCancelled", "Buchexport abgebrochen."),
        ...
        ("Origin.BookSavedChapters", "Diese Entwurfskapitel folgen deinen gespeicherten Entscheidungen. Die erzählerische Ausarbeitung ist noch nicht abgeschlossen."),
        ("Origin.OpeningSetupTitle", "Ausgangslage"),
        ("Origin.StoryReadChecking", "Die Leseausgabe deiner gespeicherten Geschichte wird geprüft…"),
        ("Origin.StoryReadRequired", "Öffne vor dem nächsten Modul deine Geschichte, fordere bei Bedarf das aktuelle Kapitel an und lies und bestätige den fertigen Text. Deine Anfangsentscheidungen sind gespeichert. Es wird kein Kapitel automatisch angefordert."),
        ("Origin.StoryReadRefresh", "Lesestatus prüfen"),
        ("Origin.AuthoringStage", "Schreibphase {0} von 3: angefragt → angestoßen → Entwurf fertig. Der Balken zeigt bestätigte Phasen, keine verstrichene Zeit. Lies und bestätige den Entwurf, um fortzufahren."),
        ("Origin.AuthoringEtaUnknown", "Restzeit: noch unbekannt — der Schreibdienst liefert keine verlässliche Schätzung. Prüfe dieselbe Anfrage erneut; du kannst die Seite sicher verlassen."),
        ("Origin.OpeningSetupRequired", "Bestätige zuerst Metatyp, Geburtsumstände und Kindheit. Diese Entscheidungen bilden die Ausgangslage, bevor das erste Erzählkapitel erzeugt wird."),
        ("Origin.OpeningSetupReady", "Metatyp, Geburtsumstände und Kindheit bilden gemeinsam das erste Kapitel. Spätere Kapitel folgen deinen nächsten bestätigten Entscheidungen."),
        ("Origin.ModuleSelectionSaved", "Modulauswahl gespeichert. Regelwirkungen und Übergang in die Karriere müssen noch geprüft und ausdrücklich bestätigt werden."),
    ...
    private static readonly IReadOnlyDictionary<string, string> Spanish = Translate(English,
        ...
        ("Origin.ContributionScope", "Aportes del módulo, no valores finales del personaje. Los efectos acumulados se revisan antes de Carrera."),
        ("Origin.EffectReviewRequired", "Esta vista guardada aún no contiene la evaluación de reglas. Selecciona de nuevo el módulo y revísalo antes de confirmar."),
        ("Origin.AttributeContribution", "Atributo · {0}: {1}"),
        ("Origin.SkillContribution", "Habilidad activa · {0}: {1}"),
        ("Origin.GroupContribution", "Grupo de habilidades · {0}: {1}"),
        ("Origin.KnowledgePoolContribution", "Reserva de habilidades de conocimiento: {0}; no concede automáticamente una habilidad o idioma nativo"),
        ("Origin.PositivePoolContribution", "Margen de Karma para cualidades positivas: {0}"),
        ("Origin.NegativePoolContribution", "Margen de Karma para cualidades negativas: {0}"),
        ("Origin.QualityLevelContribution", "{0} · nivel {1} (se aplica el mayor nivel de los módulos)"),
        ("Origin.QualityContribution", "Cualidad · {0} {1}"),
        ("Origin.SelectionContribution", "Texto de selección (sin bonificación propia): {0}"),
        ("Origin.EffectPending", "{0}: todavía requiere evaluación acumulada de reglas"),
        ("Origin.EffectSourceContext", "Contexto descriptivo de la fuente, no un aporte adicional: {0}"),
        ("Origin.Review", "Revisa la fuente exacta y los efectos anteriores antes de confirmar."), ("Origin.Confirm", "Confirmar esta decisión"),
        ("Origin.SavingDecision", "Guardando decisión…"),
        ("Origin.ReviewAnswers", "Revisar respuestas"),
        ("Origin.AnswersDetail", "Responde a las preguntas del módulo. Las respuestas obligatorias llevan *. Nada se aplica hasta que revises y confirmes."),
        ("Origin.ChooseAnswer", "Elige una respuesta"), ("Origin.EnterAnswer", "Tu respuesta"),
        ("Origin.ReadBook", "Leer tu historia"),
        ("Origin.AffordableChoicesOnly", "Solo se muestran opciones que puedes pagar con tu Karma restante."),
        ("Origin.NoAffordableChoices", "Ninguna opción cabe en el Karma restante. Vuelve para revisar tus decisiones guardadas; no se ha seleccionado otro módulo."),
        ("Origin.BookLoading", "Cargando tu historia guardada…"),
        ("Origin.ExportBook", "Guardar libro como HTML"),
        ("Origin.ExportEpub", "Guardar libro como EPUB"),
        ("Origin.SceneTitle", "Ilustración del capítulo"),
        ("Origin.SceneRemoteExplanation", "Para un capítulo vinculado y aceptado puedes solicitar una ilustración privada. Revisa o acorta el fragmento sugerido, o cámbialo por otro fragmento exacto del capítulo. El servidor elige un proveedor autorizado; revisa la imagen antes de añadirla."),
        ("Origin.SceneExcerpt", "Fragmento exacto de este capítulo (hasta 3 KB)"),
        ("Origin.SceneConsent", "Autorizo enviar este fragmento a OneMinAI o Phygital+ para una ilustración privada con créditos existentes. Sin compras ni publicación pública."),
        ("Origin.SceneRequest", "Solicitar esta ilustración"),
        ("Origin.SceneRead", "Consultar ilustración existente (sin generar)"),
        ("Origin.SceneWaiting", "Contactando con el servicio privado… Aún no hay una estimación fiable. Tu libro guardado sigue disponible."),
        ("Origin.SceneReview", "Revisa la imagen y elige «Usar esta escena» para guardarla sin conexión e incluirla en EPUB/HTML. No se publica."),
        ("Origin.SceneAbsent", "No existe una ilustración para este texto exacto. Para crearla se requiere el consentimiento de arriba."),
        ("Origin.SceneUnknown", "La ilustración puede seguir procesándose o se perdió la confirmación. Consulta la ilustración existente más tarde; no crees otra solicitud. No hay una estimación fiable."),
        ("Origin.SceneConflict", "Reabre el capítulo y comprueba que el servidor confirmó la edición elegida. No se solicitó otra imagen."),
        ("Origin.SceneUnavailable", "El servicio privado no está disponible o cambió la cuenta o el libro. El libro guardado no ha cambiado. Puedes elegir una imagen local."),
        ("Origin.SceneReject", "Rechazar esta imagen (sin regenerar)"),
        ("Origin.SceneClosed", "Esta imagen se rechazó o caducó. No se regenera automáticamente; puedes seguir usando imágenes locales."),
        ("Origin.SceneExplanation", "Archivo local: describe una escena descargada, elige un PNG/JPEG y revisa la vista previa. Elegir un archivo no inicia generación ni subida. La imagen queda privada y se incluye sin conexión en EPUB/HTML. Una escena por capítulo, hasta 8 por libro; 4 MB y 4096 píxeles por imagen, 16 MB en total."),
        ("Origin.SceneDescription", "Describe la escena para quienes no puedan ver la imagen"),
        ("Origin.SceneChoose", "Elegir una escena renderizada"),
        ("Origin.SceneSave", "Usar esta escena en mi libro"),
        ("Origin.SceneRemove", "Quitar la copia de esta escena del libro"),
        ("Origin.SceneInvalid", "No se pudo guardar la escena. Usa un PNG/JPEG válido dentro de los límites de imagen y libro. Tu libro guardado no ha cambiado."),
        ("Origin.ScenesUnavailable", "No se pudieron leer las ilustraciones guardadas. La historia sigue disponible; esta exportación solo contiene texto. Las imágenes guardadas no se han sobrescrito."),
        ("Origin.ReviewProse", "Revisar borrador del capítulo"),
        ("Origin.AuthorChapter", "Escribir capítulo con First Book AI"),
        ("Origin.AuthoringBusy", "Consultando tu solicitud privada… Puedes salir; tu libro guardado sigue disponible."),
        ("Origin.AuthoringExplanation", "Solo se envían los siguientes hechos confirmados, el nombre del runner y el idioma de la historia. No se envían archivos del personaje ni textos de reglas. El texto generado queda como borrador para tu revisión."),
        ("Origin.AuthoringConsent", "Acepto enviar estos hechos a First Book AI para este capítulo. Esto no comparte ni publica mi historia."),
        ("Origin.AuthoringRequest", "Solicitar o reanudar capítulo"),
        ("Origin.AuthoringRefresh", "Consultar solicitud existente"),
        ("Origin.AuthoringNotFound", "Todavía no hay una solicitud. Revisa los hechos y da tu consentimiento antes de solicitar el capítulo."),
        ("Origin.AuthoringQueued", "Solicitud guardada. La redacción está pendiente; puedes salir y volver más tarde."),
        ("Origin.AuthoringReconciling", "La redacción se ha iniciado. Se está recuperando el resultado; no se enviará otra generación."),
        ("Origin.AuthoringReady", "El borrador está listo para revisar. Tu edición de lectura no ha cambiado."),
        ("Origin.AuthoringUnknown", "Se perdió la respuesta. Consulta esta misma solicitud más tarde; no inicies otra generación."),
        ("Origin.AuthoringUnavailable", "La redacción no está disponible o la cuenta ha cambiado. Tu libro guardado sigue intacto."),
        ("Origin.AuthoringStatusRetrying", "Consulta de estado interrumpida. Se muestra la última etapa confirmada; se volverá a consultar la misma solicitud en breve. No se inicia otra generación."),
        ("Origin.AuthoringStatusInterrupted", "La conexión se interrumpió al consultar el capítulo. Vuelve a consultar la solicitud existente. Tu libro guardado y la última etapa confirmada siguen intactos; no se inicia otra generación."),
        ("Origin.AuthoringStatusPaused", "Las consultas automáticas alcanzaron su límite y están pausadas. Consulta de nuevo la solicitud existente para continuar. Tu libro guardado sigue intacto."),
        ("Origin.ProseStale", "Este borrador pertenece a un capítulo anterior u otro idioma. Puedes descartarlo, pero no usarlo en esta versión."),
        ("Origin.ProseReviewNotice", "Es una versión de lectura propuesta, no una historia verificada del personaje. Revisa nombres, biografía y el punto de decisión. No cambia reglas ni decisiones guardadas."),
        ("Origin.ProseCurrent", "Versión de lectura actual"), ("Origin.ProseProposed", "Texto propuesto"),
        ("Origin.ProseAcknowledgement", "He revisado este texto exacto. Usarlo en mi libro privado y confirmar este capítulo al servicio de escritura para poder continuar con el siguiente."),
        ("Origin.ProseUse", "Usar en mi libro"), ("Origin.ProseDiscard", "Descartar este borrador"),
        ("Origin.ProseReviewSaved", "Revisión guardada. Vuelve al libro para leerlo o exportarlo. No se ha publicado nada."),
        ("Origin.BookUnavailable", "No hay un libro guardado disponible en este contexto. Abre de nuevo el dosier si cambiaste de personaje o cuenta."),
        ("Origin.BookAccount", "Cuenta y privacidad"),
        ("Origin.BookAccountExplanation", "La narración con First Book AI requiere una cuenta vinculada. Puedes leer y exportar este libro guardado sin vincularla. Abrir los ajustes de cuenta no sube el runner ni inicia la generación de capítulos."),
        ("Origin.BookExported", "Libro guardado. No se ha publicado."),
        ("Origin.BookExportCancelled", "Exportación del libro cancelada."),
        ...
        ("Origin.BookSavedChapters", "Estos capítulos del borrador siguen tus decisiones guardadas. La elaboración narrativa aún no está completa."),
        ("Origin.OpeningSetupTitle", "Situación inicial"),
        ("Origin.StoryReadChecking", "Consultando la edición de lectura de tu historia guardada…"),
        ("Origin.StoryReadRequired", "Antes de elegir el siguiente módulo, abre tu historia, solicita el capítulo actual si hace falta y lee y acepta el texto terminado. Tus decisiones iniciales están guardadas. No se solicita ningún capítulo automáticamente."),
        ("Origin.StoryReadRefresh", "Consultar estado de lectura"),
        ("Origin.AuthoringStage", "Fase de escritura {0} de 3: solicitado → enviado → borrador listo. La barra muestra fases confirmadas, no tiempo transcurrido. Lee y acepta el borrador para continuar."),
        ("Origin.AuthoringEtaUnknown", "Tiempo restante: desconocido — el servicio no ha proporcionado una estimación fiable. Consulta de nuevo la misma solicitud; puedes salir sin perder el progreso."),
        ("Origin.OpeningSetupRequired", "Primero confirma el metatipo, el trasfondo del nacimiento y la infancia. Estas decisiones establecen la situación inicial antes de generar el primer capítulo narrativo."),
        ("Origin.OpeningSetupReady", "El metatipo, el trasfondo del nacimiento y la infancia forman juntos el primer capítulo. Los capítulos posteriores siguen tus siguientes decisiones confirmadas."),
        ("Origin.ModuleSelectionSaved", "Selección de módulos guardada. Los efectos de reglas y el paso a la carrera aún deben revisarse y confirmarse expresamente."),
