...
class AndroidContractTests(unittest.TestCase):
    ...
    def test_api36_e2e_workflow_pins_the_coherent_dependency_graph(self) -> None:
        ...
        for dependency, commits in (
            ("ArchonMegalon/chummer6-ui", ("3b7a828d93ea76c00c1bc07349537698238c685b",) * 2),
            (
                "ArchonMegalon/chummer6-core",
                (
                    "123f896c5e22670a965dfd2bf4cd325ea4d0ded0",
                    "89377b41ce428490d73d763f2e7aed76f983f87d",
                    "123f896c5e22670a965dfd2bf4cd325ea4d0ded0",
                ),
            ),
    ...
    def test_release_automation_is_fail_closed(self) -> None:
        ...
        self.assertNotIn("--force-evaluate", prepare)
        self.assertNotIn("--force-evaluate", build)
